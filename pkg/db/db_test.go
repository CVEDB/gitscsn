...
import (
	...
	"github.com/aquasecurity/gitscan/pkg/db"
	"github.com/aquasecurity/gitscan/pkg/oci"
)

const mediaType = "application/vnd.aquasec.gitscan.db.layer.v1.tar+gzip"
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			img.ManifestReturns(&v1.Manifest{
				Layers: []v1.Descriptor{
					{
						MediaType: "application/vnd.aquasec.gitscan.db.layer.v1.tar+gzip",
						Size:      100,
						Digest: v1.Hash{
							Algorithm: "sha256",
