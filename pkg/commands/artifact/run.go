...
import (
	...
	tcache "github.com/aquasecurity/gitscan/pkg/cache"
	"github.com/aquasecurity/gitscan/pkg/commands/operation"
	...
	"github.com/aquasecurity/gitscan/pkg/javadb"
	"github.com/aquasecurity/gitscan/pkg/log"
	"github.com/aquasecurity/gitscan/pkg/module"
	"github.com/aquasecurity/gitscan/pkg/report"
	pkgReport "github.com/aquasecurity/gitscan/pkg/report"
	"github.com/aquasecurity/gitscan/pkg/result"
	"github.com/aquasecurity/gitscan/pkg/rpc/client"
	"github.com/aquasecurity/gitscan/pkg/scanner"
	"github.com/aquasecurity/gitscan/pkg/types"
	"github.com/aquasecurity/gitscan/pkg/utils/fsutils"
)

// TargetKind represents what kind of artifact GitScan scans
...
// It is useful when GitScan is imported as a library.
...
func Run(ctx context.Context, opts flag.Options, targetKind TargetKind) (err error) {
	...
	if opts.GenerateDefaultConfig {
		log.Logger.Info("Writing the default config to gitscan-default.yaml...")
		return viper.SafeWriteConfigAs("gitscan-default.yaml")
	}
...
func initScannerConfig(opts flag.Options, cacheClient cache.Cache) (ScannerConfig, types.ScanOptions, error) {
	...
	if opts.Scanners.Enabled(types.SecretScanner) {
		...
		log.Logger.Infof("Please see also https://cvedb.github.io/gitscan/%s/docs/secret/scanning/#recommendation for faster secret detection", ver)
	} else {
