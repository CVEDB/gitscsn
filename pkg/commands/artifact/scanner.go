...
// $ gitscan image --input alpine.tar
...
// $ gitscan image --server localhost:4954 alpine:3.15
...
// $ gitscan image --server localhost:4954 --input alpine.tar
