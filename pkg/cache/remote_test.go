...
import (
	...
	rpcScanner "github.com/aquasecurity/gitscan/rpc/scanner"
	...
	"github.com/aquasecurity/gitscan/pkg/cache"
	fcache "github.com/aquasecurity/gitscan/pkg/fanal/cache"
	"github.com/aquasecurity/gitscan/pkg/fanal/types"
	rpcCache "github.com/aquasecurity/gitscan/rpc/cache"
)
...
func TestRemoteCache_PutArtifact(t *testing.T) {
	...
	mux.Handle(rpcCache.CachePathPrefix, withToken(layerHandler, "valid-token", "GitScan-Token"))
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				...
				customHeaders: http.Header{
					"GitScan-Token": []string{"valid-token"},
				},
			},
		},
		{
		...
		},
		{
			...
			args: args{
				imageID: "sha256:invalid",
				customHeaders: http.Header{
					"GitScan-Token": []string{"invalid-token"},
				},
			},
