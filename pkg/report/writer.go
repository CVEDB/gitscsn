...
import (
	...
	"github.com/aquasecurity/gitscan/pkg/compliance/spec"
	"github.com/aquasecurity/gitscan/pkg/log"
	"github.com/aquasecurity/gitscan/pkg/report/cyclonedx"
	"github.com/aquasecurity/gitscan/pkg/report/github"
	"github.com/aquasecurity/gitscan/pkg/report/predicate"
	"github.com/aquasecurity/gitscan/pkg/report/spdx"
	"github.com/aquasecurity/gitscan/pkg/report/table"
...
func Write(report types.Report, option Option) error {
	...
	case FormatTemplate:
		...
		if strings.HasPrefix(option.OutputTemplate, "@") && strings.HasSuffix(option.OutputTemplate, "sarif.tpl") {
			log.Logger.Warn("Using `--template sarif.tpl` is deprecated. Please migrate to `--format sarif`. See https://github.com/aquasecurity/gitscan/discussions/1571")
			writer = SarifWriter{
				Output:  option.Output,
				Version: option.AppVersion,
			}
