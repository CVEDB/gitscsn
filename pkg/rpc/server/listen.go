...
import (
	...
	dbFile "github.com/aquasecurity/gitscan/pkg/db"
	dbc "github.com/aquasecurity/gitscan/pkg/db"
...
// Server represents GitScan server
type Server struct {
	appVersion   string
	addr         string
	cacheDir     string
...
// ListenAndServe starts GitScan server
