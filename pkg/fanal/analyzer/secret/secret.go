...
import (
	...
	"github.com/aquasecurity/gitscan/pkg/fanal/secret"
	"github.com/aquasecurity/gitscan/pkg/fanal/types"
	"github.com/aquasecurity/gitscan/pkg/fanal/utils"
)
...
func (a *SecretAnalyzer) Init(opt analyzer.AnalyzerOptions) error {
	if opt.SecretScannerOption.ConfigPath == a.configPath && !lo.IsEmpty(a.scanner) {
		// This check is for tools importing GitScan and customize analyzers
		// Never reach here in GitScan OSS
		return nil
	}
