...
import (
	...
	aimage "github.com/aquasecurity/gitscan/pkg/fanal/artifact/image"
...
func startContainerd(t *testing.T, ctx context.Context, hostPath string) testcontainers.Container {
	...
	req := testcontainers.ContainerRequest{
		Name:       "containerd",
		Image:      "ghcr.io/aquasecurity/gitscan-test-images/containerd:latest",
...
func TestContainerd_SearchLocalStoreByNameOrDigest(t *testing.T) {
	...
	basename := "hello"
	tag := "world"
	importedImageOriginalName := "ghcr.io/aquasecurity/gitscan-test-images:alpine-310"
...
func localImageTestWithNamespace(t *testing.T, namespace string) {
	...
	tests := []struct {
		...
		{
			name:       "alpine 3.10",
			imageName:  "ghcr.io/aquasecurity/gitscan-test-images:alpine-310",
			...
			wantMetadata: types.ImageMetadata{
				...
				RepoTags:    []string{"ghcr.io/aquasecurity/gitscan-test-images:alpine-310"},
				RepoDigests: []string{"ghcr.io/aquasecurity/gitscan-test-images@sha256:f12582b2f2190f350e3904462c1c23aaf366b4f76705e97b199f9bbded1d816a"},
		...
		{
			name:       "vulnimage",
			imageName:  "ghcr.io/aquasecurity/gitscan-test-images:vulnimage",
			...
			wantMetadata: types.ImageMetadata{
				...
				RepoTags:    []string{"ghcr.io/aquasecurity/gitscan-test-images:vulnimage"},
				RepoDigests: []string{"ghcr.io/aquasecurity/gitscan-test-images@sha256:e74abbfd81e00baaf464cf9e09f8b24926e5255171e3150a60aa341ce064688f"},
				ConfigFile: v1.ConfigFile{
					Architecture: "amd64",
					Created: v1.Time{
	...
	tests := []struct {
	...
	}{
		{
			...
			wantMetadata: types.ImageMetadata{
				...
				RepoTags:    []string{"ghcr.io/aquasecurity/gitscan-test-images:alpine-310"},
				RepoDigests: []string{"ghcr.io/aquasecurity/gitscan-test-images@sha256:72c42ed48c3a2db31b7dafe17d275b634664a708d901ec9fd57b1529280f01fb"},
				ConfigFile: v1.ConfigFile{
					Architecture: "amd64",
					Created: v1.Time{
						Time: time.Date(2019, 8, 20, 20, 19, 55, 211423266, time.UTC),
