...
import (
	...
	"github.com/aquasecurity/gitscan/pkg/fanal/handler"
	"github.com/aquasecurity/gitscan/pkg/fanal/types"
	"github.com/aquasecurity/gitscan/pkg/fanal/walker"
	"github.com/aquasecurity/gitscan/pkg/log"
	"github.com/aquasecurity/gitscan/pkg/mapfs"
	"github.com/aquasecurity/gitscan/pkg/semaphore"
	"github.com/aquasecurity/gitscan/pkg/syncx"
)
...
func buildPathsToSkip(base string, paths []string) []string {
	...
	for _, path := range paths {
		...
		//       e.g. $ gitscan fs --skip-dirs bar ./foo
		...
		//       e.g. $ gitscan fs --skip-dirs ./foo/bar ./foo
		//     The skip dir will be converted to `bar/`.
		// 3. Absolute skip dirs/files
		//     The specified dirs and files wll be converted to the relative path from the root directory.
		//       e.g. $ gitscan fs --skip-dirs /bar/foo/baz ./foo
