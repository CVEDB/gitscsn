...
// DefaultCacheDir returns/creates the cache-dir to be used for gitscan operations
func DefaultCacheDir() string {
	tmpDir, err := os.UserCacheDir()
	if err != nil {
		tmpDir = os.TempDir()
	}
	return filepath.Join(tmpDir, "gitscan")
}
...
// SetCacheDir sets the gitscan cacheDir
