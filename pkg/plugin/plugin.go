...
import (
	...
	"github.com/aquasecurity/gitscan/pkg/downloader"
...
var (
	pluginsRelativeDir = filepath.Join(".gitscan", "plugins")

	officialPlugins = map[string]string{
		"kubectl": "github.com/aquasecurity/gitscan-plugin-kubectl",
		"aqua":    "github.com/aquasecurity/gitscan-plugin-aqua",
	}
)
...
func Install(ctx context.Context, url string, force bool) (Plugin, error) {
	...
	// e.g. kubectl => github.com/aquasecurity/gitscan-plugin-kubectl
