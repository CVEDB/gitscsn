...
func TestPlugin_Run(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				Name:        "test_plugin",
				Repository:  "github.com/aquasecurity/gitscan-plugin-test",
				Version:     "0.1.0",
				Usage:       "test",
				Description: "test",
				Platforms: []plugin.Platform{
					{
						...
						URI: "github.com/aquasecurity/gitscan-plugin-test",
						Bin: "test.sh",
					},
				},
				GOOS:   "linux",
		...
		},
		{
			...
			fields: fields{
				Name:        "error_plugin",
				Repository:  "github.com/aquasecurity/gitscan-plugin-error",
				Version:     "0.1.0",
				Usage:       "test",
				Description: "test",
				Platforms: []plugin.Platform{
...
func TestInstall(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantFile: ".gitscan/plugins/test_plugin/test.sh",
		},
		{
...
func TestUninstall(t *testing.T) {
	...
	tempDir := t.TempDir()
	pluginDir := filepath.Join(tempDir, ".gitscan", "plugins", pluginName)
