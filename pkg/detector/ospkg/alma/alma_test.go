...
import (
	...
	"github.com/aquasecurity/gitscan/pkg/dbtest"
				...
				pkgs: []ftypes.Package{
					{
						...
						Modularitylabel: "", // ref: https://bugs.almalinux.org/view.php?id=173 ,  https://github.com/aquasecurity/gitscan/issues/2342#issuecomment-1158459628
						Licenses:        []string{"BSD"},
						Layer:           ftypes.Layer{},
					},
				},
