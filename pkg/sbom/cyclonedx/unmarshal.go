...
func (c *CycloneDX) UnmarshalJSON(b []byte) error {
	...
	if bom.Metadata != nil {
		...
		if bom.Metadata.Component != nil {
			metadata.Component = toGitScanCdxComponent(lo.FromPtr(bom.Metadata.Component))
		}
	}

	var components []ftypes.Component
	for _, component := range lo.FromPtr(bom.Components) {
		components = append(components, toGitScanCdxComponent(component))
	}
...
func (c *CycloneDX) parseSBOM(bom *cdx.BOM) error {
	...
	for bomRef := range c.dependencies {
		...
		case cdx.ComponentTypeApplication: // It would be a lock file in a CycloneDX report generated by GitScan
...
func toGitScanCdxComponent(component cdx.Component) ftypes.Component {
...
func isGitScanSBOM(c *cdx.BOM) bool {
