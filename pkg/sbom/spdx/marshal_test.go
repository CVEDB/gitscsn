...
import (
	...
	tspdx "github.com/aquasecurity/gitscan/pkg/sbom/spdx"
	...
	}{
		{
			...
			wantSBOM: &spdx.Document2_2{
				CreationInfo: &spdx.CreationInfo2_2{
					...
					DocumentNamespace:    "http://cvedb.github.io/gitscan/container_image/rails:latest-3ff14136-e09f-4df9-80ea-000000000001",
					CreatorOrganizations: []string{"aquasecurity"},
					CreatorTools:         []string{"gitscan"},
		...
		},
		{
			...
			wantSBOM: &spdx.Document2_2{
				CreationInfo: &spdx.CreationInfo2_2{
					...
					DocumentNamespace:    "http://cvedb.github.io/gitscan/container_image/centos:latest-3ff14136-e09f-4df9-80ea-000000000001",
					CreatorOrganizations: []string{"aquasecurity"},
					CreatorTools:         []string{"gitscan"},
					Created:              "2021-08-25T12:20:30Z",
				},
		...
		},
		{
			...
			wantSBOM: &spdx.Document2_2{
				CreationInfo: &spdx.CreationInfo2_2{
					...
					DocumentNamespace:    "http://cvedb.github.io/gitscan/filesystem/masahiro331/CVE-2021-41098-3ff14136-e09f-4df9-80ea-000000000001",
					CreatorOrganizations: []string{"aquasecurity"},
					CreatorTools:         []string{"gitscan"},
					Created:              "2021-08-25T12:20:30Z",
				},
		...
		},
		{
			...
			wantSBOM: &spdx.Document2_2{
				CreationInfo: &spdx.CreationInfo2_2{
					...
					DocumentNamespace:    "http://cvedb.github.io/gitscan/repository/test-aggregate-3ff14136-e09f-4df9-80ea-000000000001",
					CreatorOrganizations: []string{"aquasecurity"},
					CreatorTools:         []string{"gitscan"},
					Created:              "2021-08-25T12:20:30Z",
				},
		...
		},
		{
			...
			wantSBOM: &spdx.Document2_2{
				CreationInfo: &spdx.CreationInfo2_2{
					...
					DocumentNamespace:    "http://cvedb.github.io/gitscan/filesystem/empty/path-3ff14136-e09f-4df9-80ea-000000000001",
					CreatorOrganizations: []string{"aquasecurity"},
					CreatorTools:         []string{"gitscan"},
					Created:              "2021-08-25T12:20:30Z",
				},
