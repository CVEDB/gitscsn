...
const defaultJavaDBRepository = "ghcr.io/aquasecurity/gitscan-java-db"
...
var (
	...
	JavaDBRepositoryFlag = Flag{
		...
		Usage:      "OCI repository to retrieve gitscan-java-db from",
	}
	LightFlag = Flag{
		Name:       "light",
		ConfigName: "db.light",
...
func (f *DBFlagGroup) ToOptions() (DBOptions, error) {
	...
	if light {
		log.Logger.Warn("'--light' option is deprecated and will be removed. See also: https://github.com/aquasecurity/gitscan/discussions/1649")
	}
