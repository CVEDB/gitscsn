...
import (
	...
	"github.com/aquasecurity/gitscan-java-db/pkg/db"
	"github.com/aquasecurity/gitscan-java-db/pkg/types"
	"github.com/aquasecurity/gitscan/pkg/log"
	"github.com/aquasecurity/gitscan/pkg/oci"
)

const (
	mediaType = "application/vnd.aquasec.gitscan.javadb.layer.v1.tar+gzip"
)
