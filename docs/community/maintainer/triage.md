...
Triage is an important part of maintaining the health of the gitscan repo.
...
- `kind/documentation` - Updates or additions to gitscan documentation
...
>
> \*  The exact `gitscan` command line used
>
> \*  The exact image you want to scan
>
> \*  The full output of the `gitscan` command, preferably with `--debug` for extra logging.
>
>
...
> Could you please check to see if gitscan <x> addresses this issue? We've made some changes with how this is handled, and improved the gitscan logs output to help us debug tricky cases like this.
...
>@author: I believe this issue is now addressed by gitscan v1.0.0, as it <reason>. If you still see this issue with gitscan v1.0 or higher, please reopen this issue.
>
...
>
>\* Whether the issue occurs with the latest gitscan release
>
>\* The exact `gitscan` command line used
>
>\* The exact image you want to scan
...
We use two labels [help wanted](https://github.com/aquasecurity/gitscan/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22)
and [good first issue](https://github.com/aquasecurity/gitscan/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
