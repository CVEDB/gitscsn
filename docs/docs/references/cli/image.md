...
Usage:
  gitscan image [flags] IMAGE_NAME
...
Report Flags
  ...
  -f, --format string          format (table, json, sarif, template, cyclonedx, spdx, spdx-json, github, cosign-vuln) (default "table")
      ...
      --ignorefile string      specify .gitscanignore file (default ".gitscanignore")
...
DB Flags
      ...
      --java-db-repository string   OCI repository to retrieve gitscan-java-db from (default "ghcr.io/aquasecurity/gitscan-java-db")
...
Secret Flags
      --secret-config string   specify a path to config file for secret scanning (default "gitscan-secret.yaml")
...
Client/Server Flags
      ...
      --token-header string      specify a header name for token in client/server mode (default "GitScan-Token")
