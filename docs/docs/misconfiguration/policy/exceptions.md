...
GitScan supports two types of exceptions.
...
You can get the package names in the [defsec repository][defsec] or the JSON output from GitScan.

For more details, see [an example][rule-example].

[ns-example]: https://github.com/aquasecurity/gitscan/tree/{{ git.commit }}/examples/misconf/namespace-exception
[rule-example]: https://github.com/aquasecurity/gitscan/tree/{{ git.commit }}/examples/misconf/rule-exception
