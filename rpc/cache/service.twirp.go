...
func NewCacheProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Cache {
	...
	serviceURL += baseServicePath(pathPrefix, "gitscan.cache.v1", "Cache")
	urls := [4]string{
...
func (c *cacheProtobufClient) PutArtifact(ctx context.Context, in *PutArtifactRequest) (*google_protobuf2.Empty, error) {
	ctx = ctxsetters.WithPackageName(ctx, "gitscan.cache.v1")
...
const CachePathPrefix = "/twirp/gitscan.cache.v1.Cache/"
...
func (s *cacheServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "gitscan.cache.v1.Cache" {
...
func (s *cacheServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "gitscan.cache.v1", "Cache")
}
