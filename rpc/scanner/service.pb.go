...
// Result is the same as github.com/aquasecurity/gitscan/pkg/report.Result
type Result struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
var file_rpc_scanner_service_proto_goTypes = []interface{}{
	(*ScanRequest)(nil),                     // 0: gitscan.scanner.v1.ScanRequest
	(*Licenses)(nil),                        // 1: gitscan.scanner.v1.Licenses
	(*ScanOptions)(nil),                     // 2: gitscan.scanner.v1.ScanOptions
	(*ScanResponse)(nil),                    // 3: gitscan.scanner.v1.ScanResponse
	(*Result)(nil),                          // 4: gitscan.scanner.v1.Result
	nil,                                     // 5: gitscan.scanner.v1.ScanOptions.LicenseCategoriesEntry
	(*common.OS)(nil),                       // 6: gitscan.common.OS
	(*common.Vulnerability)(nil),            // 7: gitscan.common.Vulnerability
	(*common.DetectedMisconfiguration)(nil), // 8: gitscan.common.DetectedMisconfiguration
	(*common.Package)(nil),                  // 9: gitscan.common.Package
	(*common.CustomResource)(nil),           // 10: gitscan.common.CustomResource
	(*common.SecretFinding)(nil),            // 11: gitscan.common.SecretFinding
}
var file_rpc_scanner_service_proto_depIdxs = []int32{
	2,  // 0: gitscan.scanner.v1.ScanRequest.options:type_name -> gitscan.scanner.v1.ScanOptions
	5,  // 1: gitscan.scanner.v1.ScanOptions.license_categories:type_name -> gitscan.scanner.v1.ScanOptions.LicenseCategoriesEntry
	6,  // 2: gitscan.scanner.v1.ScanResponse.os:type_name -> gitscan.common.OS
	4,  // 3: gitscan.scanner.v1.ScanResponse.results:type_name -> gitscan.scanner.v1.Result
	7,  // 4: gitscan.scanner.v1.Result.vulnerabilities:type_name -> gitscan.common.Vulnerability
	8,  // 5: gitscan.scanner.v1.Result.misconfigurations:type_name -> gitscan.common.DetectedMisconfiguration
	9,  // 6: gitscan.scanner.v1.Result.packages:type_name -> gitscan.common.Package
	10, // 7: gitscan.scanner.v1.Result.custom_resources:type_name -> gitscan.common.CustomResource
	11, // 8: gitscan.scanner.v1.Result.secrets:type_name -> gitscan.common.SecretFinding
	1,  // 9: gitscan.scanner.v1.ScanOptions.LicenseCategoriesEntry.value:type_name -> gitscan.scanner.v1.Licenses
	0,  // 10: gitscan.scanner.v1.Scanner.Scan:input_type -> gitscan.scanner.v1.ScanRequest
	3,  // 11: gitscan.scanner.v1.Scanner.Scan:output_type -> gitscan.scanner.v1.ScanResponse
