    ...
    {{- end}}
        {
            ...
            "GeneratorId": "GitScan/{{ .VulnerabilityID }}",
            ...
            "Title": "GitScan found a vulnerability to {{ .VulnerabilityID }} in container {{ $target }}, related to {{ .PkgName }}",
            ...
            {{ end -}}
            "ProductFields": { "Product Name": "GitScan" },
            "Resources": [
                {
                    "Type": "Container",
                    "Id": "{{ $target }}",
            ...
            {{- end}}
        {
            ...
            "Title": "GitScan found a misconfiguration in {{ $target }}: {{ .Title }}",
            "Description": {{ escapeString $description | printf "%q" }},
            "Remediation": {
                "Recommendation": {
                    "Text": "{{ .Resolution }}",
            ...
            {{- end -}}
        {
            ...
            "Title": "GitScan found a secret in {{ $target }}: {{ .Title }}",
            "Description": "GitScan found a secret in {{ $target }}: {{ .Title }}",
            "ProductFields": { "Product Name": "GitScan" },
            "Resources": [
                {
                    "Type": "Other",
