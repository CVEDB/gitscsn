...
```bash
$ gitscan conf --severity HIGH,CRITICAL configs
...
```bash
$ gitscan conf --file-patterns "dockerfile:.*.docker" --file-patterns "yaml:deployment" configs
gitscan conf --severity HIGH,CRITICAL --file-patterns "dockerfile:.*.docker" --file-patterns "yaml:deployment" configs
